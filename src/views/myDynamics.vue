	...
	<div class="card-list-hmc mt30" v-for="item in listData">
		<div class="clh-item bgff bt bb mb30">
			<div class="cit p30 yt">
				<div class="img-wrap user-photo user-photo-s round mr30" :style="{backgroundImage: 'url('+item.avatar+')'}" v-link="{name:'user',params:{userId:item.uid}}">
				</div>
				<div class="yt-f1">
					<div class="lh1">
    ...
    export default {
        ...
        methods:{
            ...
            getData:function(type){
                this.$http.get('feed/my/'+this.pageindex+'/'+this.pagesize).then(function(res){
