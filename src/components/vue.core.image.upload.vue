...
<template>
  <div class="g-core-image-upload-btn" v-bind:class="class">
      {{text}}
      <form class="g-core-image-upload-form" v-show="!hasImage" method="post" enctype="multipart/form-data" action="/api2/common_user/cropHeadUrl" style="cursor: pointer; width: 100%; height: 100%; opacity: 0; margin: 0px; padding: 0px; overflow: hidden;">
      ...
      tryAjaxUpload(callback) {
        ...
        xhr('POST',this.url,{},data,function(res) {
          ...
          if(self.crop) {
           ...
           console.log(self)
           self.__dispatch(self.uploadck,res);
        });  
      },
